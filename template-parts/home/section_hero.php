<section class="bg-black text-white relative">
    <div class="padding-global h-screen flex md:flex-row flex-col gap-6 justify-end md:items-end py-6 relative z-10">
        ...
        <div class="flex gap-4 md:justify-end shrink-0">
            <a href="/" class="button ghost" data-button="button">Enquire
