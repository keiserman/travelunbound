<section class="bg-white">
    ...
    if ($approach_query->have_posts()) {
        ...
        while ($approach_query->have_posts()) {
            ...
            echo '<div data-faq="faq" class="padding-global border-b py-10 relative cursor-pointer overflow-hidden">';
            echo '<h3 data-faq="title" class="text-[3.375rem] leading-none font-serif m-auto max-w-3xl z-10 relative">' . get_the_title() . '</h3>';
