...
$contact_hero_mobile_image = esc_url(get_theme_mod("contact_hero_mobile_image"));
...
<section>
    <div class="flex relative h-[90vh] items-center justify-center text-center text-white">
        ...
        <video class="hidden lg:block absolute w-full h-full object-cover bg-black" poster="<?php echo $contact_hero_video_poster; ?>" autoplay playsinline muted loop>
            <source src="<?php echo $contact_hero_video; ?>" type="video/mp4">
        </video>
        <img src="<?php echo $contact_hero_mobile_image ?>" class="lg:hidden absolute w-full h-full object-cover bg-black">
    </div>
    <div class="padding-global">
