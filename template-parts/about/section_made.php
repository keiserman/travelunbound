            ...
            <div class="grid md:grid-cols-2 gap-4 items-stretch">
                ...
                <div class="flex flex-col justify-between">
                    <div class="flex flex-col justify-start gap-2">
                        <h2 class="font-serif lg:text-6xl text-4xl">the fast-changing landscape, cut through the noise and remove stress, uncertainty, and friction from the entire process.</h2>
                    </div>
                    <div class="flex gap-2 flex-col md:pl-20">
